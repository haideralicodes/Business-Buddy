...
/**
 * Invented app window: the "real product proof" that sits on the accent panel
 * under the hero. Everything here is built from our own tokens so it reads as
  ...
  return (
    <div className="relative bg-primary">
      ...
      <div className="relative mx-auto w-[92%] max-w-[1180px] pt-12 md:pt-14">
        <div className="overflow-hidden rounded-t-xl border border-b-0 border-black/10 bg-card text-card-foreground shadow-[0_30px_80px_-30px_rgba(0,0,0,0.45)]">
          {/* Title bar */}
